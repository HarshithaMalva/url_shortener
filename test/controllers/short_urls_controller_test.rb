...
class ShortUrlsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create short_url" do
    assert_difference('ShortUrl.count') do
      post short_urls_url, params: { short_url: { actual_url: @short_url.actual_url, shortened_url: @short_url.shortened_url, user_id: @short_url.user_id } }
    end
  ...
  test "should update short_url" do
    patch short_url_url(@short_url), params: { short_url: { actual_url: @short_url.actual_url, shortened_url: @short_url.shortened_url, user_id: @short_url.user_id } }
